...
class OmnigentError(Exception):
    ...
    def __init__(
        ...
        *,
        ...
        :param owner_addr: Internal pod address for a wrong-replica
            classification. It is consumed by the server middleware and
            never serialized in the client-facing error response.
        """
